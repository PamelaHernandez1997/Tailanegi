...
# La suma de las poblaciones base (p0) es exactamente 71,376,079
REGIONS = {
    'Northern': {
...
@app.route('/')
def index():
    """Sirve la interfaz de usuario principal."""
...
def solve_population():
    ...
    if region_key == 'Total':
        ...
        # Método de Bisección para hallar t tal que sum(p0 * e^(k*t)) = target
        low_t = 0.0
        ...
        steps = [
            ...
            f"2. Se establece P_total(t) = {target:,.0f}",
            "3. Al no existir solución analítica directa para suma de exponenciales, se aplica el método numérico de bisección.",
...
if __name__ == '__main__':
    # Ejecuta el servidor Flask en puerto 5000 de forma local
